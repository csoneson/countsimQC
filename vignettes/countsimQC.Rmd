...
This function can generate either an HTML file (by setting `outputFormat = 
"html_document"` or `outputFormat=NULL`) or a pdf file (by setting 
`outputFormat = "pdf_document"`). The `description` argument can be used to
