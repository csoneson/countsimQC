...
- by setting `calculateStatistics = TRUE` and `permutationPvalues = TRUE`,
permutation of data set labels will be used to evaluate the significance of the
statistics calculated in the previous point.

Here, for the sake of speed, we calculate statistics for a small subset of the
observations (`subsampleSize = 25`) and refrain from calculateing permutation
p-values.
