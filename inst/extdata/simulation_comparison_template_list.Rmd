...
ow2 <- paste0(panelSize * colRow[1] * 72, "px")
oh2 <- paste0(panelSize * colRow[2] * 72, "px")
...
```{r nSamples, fig.width = fw1, fig.height = fh1, out.width = ow1, out.height = oh1}
plots[["nSamples"]] <- 
...
```{r nVariables, fig.width = fw1, fig.height = fh1, out.width = ow1, out.height = oh1}
plots[["nVariables"]] <- 
...
```{r BCVedgeR, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
plots[["BCVedgeR"]] <- 
...
```{r dispersionDESeq2, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r meanVarSepScatter, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r meanVarOverlaidScatter, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r libsizeSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r libsizeOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r libsizeDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r libsizeDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r libsizeBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["libsizeBox"]] <- 
...
```{r libsizeViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["libsizeViolin"]] <- 
...
```{r libsizeEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["libsizeEcdf"]] <- 
  ggplot(sampleDF, aes(x = Libsize, group = dataset, color = dataset)) + 
...
```{r tmmSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
plots[["tmmSepHist"]] <- 
...
```{r tmmOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r tmmDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["tmmDensity"]] <- 
...
```{r tmmDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r tmmBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["tmmBox"]] <- 
...
```{r tmmViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["tmmViolin"]] <- 
...
```{r tmmEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["tmmEcdf"]] <- 
  ggplot(sampleDF, aes(x = TMM, group = dataset, color = dataset)) + 
  stat_ecdf(size = 1.5, alpha = 0.5) + ylab("Cumulative proportion") + 
  xlab("TMM normalization factor") + thm
...
```{r effLibsizeSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r effLibsizeOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r effLibsizeDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r effLibsizeDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r effLibsizeBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["effLibsizeBox"]] <- 
...
```{r effLibsizeViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r effLibsizeEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r logCPMSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
plots[["logCPMSepHist"]] <- 
...
```{r logCPMOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r logCPMDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["logCPMDensity"]] <- 
...
```{r logCPMDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r logCPMBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["logCPMBox"]] <- 
...
```{r logCPMViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["logCPMViolin"]] <- 
...
```{r logCPMEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["logCPMEcdf"]] <- 
  ggplot(featureDF, aes(x = AveLogCPM, group = dataset, color = dataset)) + 
  stat_ecdf(size = 1.5, alpha = 0.5) + ylab("Cumulative proportion") + 
  xlab("Average log CPM") + thm
...
```{r fraczeroSampleSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r fraczeroSampleOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroSampleDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroSampleDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroSampleBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroSampleViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroSampleEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroFeatureSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r fraczeroFeatureOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroFeatureDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroFeatureDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroFeatureBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroFeatureViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r fraczeroFeatureEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r sampleCorrSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r sampleCorrOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r sampleCorrDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r sampleCorrDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r sampleCorrBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
plots[["sampleCorrBox"]] <- 
...
```{r sampleCorrViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r sampleCorrEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r featureCorrSepHist, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r featureCorrOverlaidHist, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r featureCorrDensity, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r featureCorrDensityFilled, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r featureCorrBox, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r featureCorrViolin, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r featureCorrEcdf, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r libsizeFraczeroSepScatter, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r libsizeFraczeroOverlaidScatter, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
...
```{r logCPMFraczeroSepScatter, fig.width = fw2, fig.height = fh2, out.width = ow2, out.height = oh2}
...
```{r logCPMFraczeroOverlaidScatter, fig.width = fw3, fig.height = fh3, out.width = ow3, out.height = oh3}
